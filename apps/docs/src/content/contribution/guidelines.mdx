...
> **Hey there!** 👋 These guidelines might look like a lot, but don't let that intimidate you! Think of them as helpful guardrails, not obstacles. We all learn as we go, and code reviews are here to help, not judge. Ready to dive in?
...
> **The secret sauce of open source?** It's the community! Some of the best learning happens in code reviews and discussions. Don't be afraid to ask questions, share ideas, or help others. We're building something cool together! 🎉
...
**📧 Contact:** [dev.hashcodes@gmail.com](mailto:dev.hashcodes@gmail.com)  

- **Do not** open public issues for security vulnerabilities
- Email security concerns to the maintainers privately
- Include reproduction steps, potential impact, and any relevant attachments
- Allow time for a fix before public disclosure

## What to Avoid

*Psst... we've all written code we're not proud of later. These aren't here to make you feel bad - they're lessons learned from collective experience. If you spot any of these in your code during review, it's totally fine! That's what reviews are for.* 😊

### Code Anti-Patterns
- ❌ Magic numbers - use named constants
- ❌ Deep nesting - extract functions
- ❌ Large functions - keep them focused and small
- ❌ God objects - follow single responsibility principle
- ❌ Premature optimization - profile first

### React Anti-Patterns
- ❌ Index as key in mapped lists
- ❌ Non-interactive handlers on static elements
...
*This checklist looks long, but most items are quick checks! The automated tools (linting, formatting, CI) do a lot of the heavy lifting for you. Just tick them off as you go!* ✅
...
> **Remember:** Behind every GitHub username is a real person who cares about this project. A little kindness and understanding goes a long way in making open source a great place to be! 💚

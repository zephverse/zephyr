...
<Callout type="info">
Aura is an active system that rewards participation. The methodology is transparent and evolving.
</Callout>

Aura is Zephyr's reputation system that rewards meaningful contributions:

- **How you earn Aura**:
  - **Post creation**: +10 base points for creating a post
  - **Rich content**: Bonus points for attaching media (images: +20-45, videos: +40-60, audio: +25-41, code: +15-60)
  - **HackerNews shares**: +15 for sharing and commenting on HN stories
  - **Receiving follows**: +5 when someone follows you
  - **Upvotes**: Users can vote on your posts to increase your Aura
  - **View milestones**: Earn rewards when your posts reach view thresholds

- **Maximum rewards**: Capped at 150 Aura per post to prevent gaming the system

- **Transparency**: All Aura changes are logged with type, amount, and source for full auditability

- **Purpose**: Aura improves content discoverability and highlights quality contributors without gating core features
